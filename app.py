...
def check(email):
    url = "https://mzy958rl3c.execute-api.ap-south-1.amazonaws.com/getdata/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://mzy958rl3c.execute-api.ap-south-1.amazonaws.com/registration/registration?"+params
...
@app.route('/stats')
def stats():
    url = "https://mzy958rl3c.execute-api.ap-south-1.amazonaws.com/plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    print(address)
    url = "https://mzy958rl3c.execute-api.ap-south-1.amazonaws.com/getbloodgrp/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
    ...
    for i in a:
        url="https://www.fast2sms.com/dev/bulk?authorization=teWZ4GKvAPEVyc51Oq8gn0YrsphowfFNMDakzI362CuLBjmH9l2CUgWo84wjMynvkKsxaphQYmAcV3f1&sender_id=FSTSMS&message="+msg+"&language=english&route=p&numbers="+str(i['phone'])
